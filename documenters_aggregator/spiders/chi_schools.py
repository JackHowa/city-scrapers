...
class Chi_schoolsSpider(Spider):
    ...
    def _parse_description(self, item):
        ...
        """
        return 'The Chicago Board of Education is responsible for the governance, organizational and financial oversight of Chicago Public Schools (CPS), the third largest school district in the United States of America'
